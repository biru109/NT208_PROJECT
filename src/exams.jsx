        ...
        {(exercisesByGrade[selectedGrade] || []).map((item, index) => (
          <div className="card" key={index}>
            ...
            <div className="card-content">
              ...
              <button className="start-btn">Bắt đầu làm</button>
            </div>
          </div>
        ))}
      </div>
...
//     <div className="baitap-container">
//       <h2 className="title">ĐỀ THI TOÁN {selectedGrade.toUpperCase()}</h2>
//       <p className="subtitle">Luyện tập những đề thi được biên soạn bởi những Giáo viên giàu kinh nghiệm.</p>
...
//             onClick={() => setSelectedGrade(tab)}
//           >
//             {tab === "Lớp 1" && <img src={BulbIcon} alt="bulb icon" className="icon-img" />}
//             {tab}
//           </button>
//         ))}
//       </div>
