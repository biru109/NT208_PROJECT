...
const courseInfo = {
  ...
  description:
    "Phát triển tư duy toán học với các bài tập nâng cao dành cho học sinh giỏi",
  lessons: 25,
  ...
  return (
    <div>
      ...
      <div className="bg-[#f5f9ff] min-h-screen px-6 py-[4%] font-noto text-black">
        ...
        <p className=" text-center text-lg mb-6 mt-4">
          Hoàn tất thông tin để bắt đầu hành trình học tập!!
        </p>
          ...
          <div className="max-w w-full bg-white px-8 py-2 rounded-3xl shadow-md">
            ...
            <div className="flex justify-between gap-8">
              ...
              <div className="flex-[4] bg-white rounded-3xl shadow-xl font-montserrat h-[450px]">
                ...
                <div className="px-6">
                  <p className="text-lg font-semibold mb-1 mt-4">
                    {" "}
                    {courseInfo.title}{" "}
                  </p>
                  <p className="text-[#808080] mb-2 text-md">
                    {courseInfo.description}
                  </p>
                  <div className="flex gap-2 mt-8">
                    <img src={dk} alt="sobaihoc" />
                    <span className="mt-1 text-black">
                      {courseInfo.lessons} bài học
                    </span>
                  </div>
              ...
              <div className="flex-[6] bg-white p-6 rounded-3xl border-2 border-[#f0f0f0] shadow-2xl mb-24">
                <h3 className="text-2xl font-bold mb-3 font-noto">
                  Thông tin đăng ký
                </h3>
                <hr className="kengang" />
                <label className="block mb-4 mt-8 font-bold text-xl">
                  Họ và tên
                </label>
                <input
                  ref={nameInputRef}
                ...
                <label className="block mb-4 mt-12 font-bold text-xl">
                  Giới tính
                </label>
                <select
                ...
                <div className="flex justify-center mb-6">
                  <button
                    ...
                    className="w-[85%] h-16 bg-[#386DCC] text-white p-2 rounded-2xl mt-12 text-2xl font-bold"
                  >
                    Ghi danh ngay
                  </button>
                </div>
